...
def controla_robot(e, r):
    def robot_nao_conhece():
        ...
        if robot_sente_parede(e):        
            ...
            if r.estado_direccao_robot() == este and r.mapa.mapa_objecto_em(posicao(r.estado_posicao_robot().posicao_linha(),r.estado_posicao_robot().posicao_coluna()).posicao_relativa(sul)) == desconhecido:
            ...
            if r.estado_direccao_robot() == norte and r.mapa.mapa_objecto_em(posicao(r.estado_posicao_robot().posicao_linha(),r.estado_posicao_robot().posicao_coluna()).posicao_relativa(este)) == desconhecido:
                robot_vira_direita(e)
                r.estado_robot_vira_direita()
                return e
            ...
            if r.estado_direccao_robot() == oeste and r.mapa.mapa_objecto_em(posicao(r.estado_posicao_robot().posicao_linha(),r.estado_posicao_robot().posicao_coluna()).posicao_relativa(sul)) == desconhecido:
                robot_vira_esquerda(e)
                r.estado_robot_vira_esquerda()
                return e
            ...
            if r.estado_direccao_robot() == sul and r.mapa.mapa_objecto_em(posicao(r.estado_posicao_robot().posicao_linha(),r.estado_posicao_robot().posicao_coluna()).posicao_relativa(este)) == desconhecido:
                robot_vira_esquerda(e)
                r.estado_robot_vira_esquerda()
                return e
    ...
    if r.mapa.mapa_objecto_em(posicao(r.estado_posicao_robot().posicao_linha(),r.estado_posicao_robot().posicao_coluna()).posicao_relativa(vira_esquerda(r.estado_direccao_robot()))) == desconhecido:
            robot_vira_esquerda(e)
            r.estado_robot_vira_esquerda()
            robot_nao_conhece()    
    
    if r.mapa.mapa_objecto_em(posicao(r.estado_posicao_robot().posicao_linha(),r.estado_posicao_robot().posicao_coluna()).posicao_relativa(r.estado_direccao_robot())) == desconhecido:
        robot_nao_conhece()
